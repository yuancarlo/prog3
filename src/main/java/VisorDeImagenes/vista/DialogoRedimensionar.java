    ...
    public DialogoRedimensionar(Frame padre, ModeloImagen modelo) {
        ...
        txtAncho.addKeyListener(new KeyAdapter() {
            public void keyReleased(KeyEvent e) {
                if (chkProporcional.isSelected() && !txtAncho.getText().isEmpty()) {
                    try {
                        int w = Integer.parseInt(txtAncho.getText());
                        txtAlto.setText(String.valueOf(modeloRef.obtenerAltoProporcional(w)));
        ...
        add(chkProporcional); add(new JLabel(""));
